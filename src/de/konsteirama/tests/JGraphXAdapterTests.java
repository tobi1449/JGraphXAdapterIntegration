...
public class JGraphXAdapterTests {
    ...
    /**
     * Compares a collection to a set. Returns true if the specified parameters
     * have the same size, and every member of the specified parameters is
     * contained in this set (or equivalently, every member of the parameter is
     ...
     * 
     */
    private <T> boolean compare(final Collection<T> collection, final Set<T> set) {
        ...
        // // test for equal size
        // // because collection can have duplicates, test for < rather than !=
